...
static int dss_pll_write_config(struct dss_pll *pll, const struct dss_pll_clock_info *cinfo)
{
/* PLL is already config in U-boot,do nothing here */
#if 0
	return dss_pll_write_config_type_a(pll, cinfo);
#else
	return 0;
#endif
}
...
static const struct dss_pll_ops dss_pll_ops = {
	...
	.set_config = dss_pll_write_config,
};
