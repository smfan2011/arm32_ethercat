...
{
	struct sii9022_audio_dev *dd = dev_get_drvdata(dai->dev);
...
int sii9022_hdmi_codec_register(struct device *dev, struct regmap *regmap)
{
	// struct sii9022_audio_dev *dd = dev_get_drvdata(dev);
	struct device_node *node = dev->of_node;
	int ret, i;
	int fifos_enabled = 0;


	struct sii9022_audio_dev *dd;
